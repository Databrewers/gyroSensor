...
void WHO_AM_I(I2C_HandleTypeDef* hi2c)
{
	...
	uint8_t register_to_access = 0x75 ; //ADDRESS_WHO_AM_I; //접근할 레지스터(WHO_AM_I)의 주소
...
void set_sample_rate(I2C_HandleTypeDef* hi2c, uint16_t sample_rate_you_want) 
{
    ...
    uint8_t calculated_SMPLRT_DIV = (8000/sample_rate_you_want) - 1; // gyro_output_rate == 8000
